...
from datastores.data_versions import DataVersions
from datastores.datastore import Datastore, CombinedDatastore
...
from zeta_policy import ZetaPolicy
...
def get_environment(data_version: DataVersions, datastore: Datastore, custom_split: float = None) -> gym.Env:
    ...
    if data_version in [DataVersions.KITCHEN_ESD]:
